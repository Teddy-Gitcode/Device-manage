import { IconChevronRight, IconWifi, IconBell, IconDatabase, IconCpu, IconUser } from '@/components/ui/Icons'
    ...
    <div className="page-fade">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 0, maxWidth: 800 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
          <IconUser size={14} style={{ color: 'var(--neutral-fg-3)' }} />
          <span style={{ fontSize: 11, fontWeight: 600, color: 'var(--neutral-fg-3)', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
            Account
          </span>
        </div>
        <ProfileSection />
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
          <IconCpu size={14} style={{ color: 'var(--neutral-fg-3)' }} />
          <span style={{ fontSize: 11, fontWeight: 600, color: 'var(--neutral-fg-3)', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 24 }}>
          {sections.map((sec, si) => {
            ...
            return (
              <div className="card stagger" key={sec.title} style={{ padding: '14px 16px', '--i': si + 2 } as React.CSSProperties}>
